<?php
/**
 * Initiator and ARCHER Autoloader
 *
 * PHP version 5
 *
 * This file simply is the initator.  It establishes the ARCHER GUI and system
...
class Initiator
{
    ...
    {
        $token = ARCHERCore::createSecToken();
    ...
    public static function startInit()
    {
        ...
        self::_verCheck();
        /**
         * Check if the extensions archer needs are available.
         */
        self::_extCheck();
        /**
    ...
    private static function _verCheck()
    {
        try {
            ...
            if (!version_compare(phpversion(), '5.5.0', '>=')) {
                throw new Exception(
                    sprintf(
                        'ARCHER Requires PHP v5.5.0 or higher. You have PHP v%s',
                        phpversion()
                    )
                );
            }
