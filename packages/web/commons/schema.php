...
$this->schema[] = array(
    ...
    . ') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC',
    "INSERT IGNORE INTO `users` VALUES ('','archer', MD5('password'), NOW(), '')",
...
$this->schema[] = array(
    ...
    . 'VALUES'
    . "('ARCHER_TFTP_HOST','Hostname or IP address of the TFTP Server.','"
    . TFTP_HOST
    . "','TFTP Server'),"
    . "('ARCHER_TFTP_FTP_USERNAME','Username used to access the tftp server via ftp.','"
    . TFTP_FTP_USERNAME
    . "','TFTP Server'),"
    . "('ARCHER_TFTP_FTP_PASSWORD','Password used to access the tftp server via ftp.','"
    . TFTP_FTP_PASSWORD
    . "','TFTP Server'),"
    . "('ARCHER_TFTP_PXE_KERNEL_DIR','Location of kernel files on the PXE server.','"
    . TFTP_PXE_KERNEL_DIR
    . "','TFTP Server'),"
    . "('ARCHER_TFTP_PXE_KERNEL','Location of kernel file on the PXE server,"
    . "this should point to the kernel itself.','"
    . PXE_KERNEL
    . "','TFTP Server'),"
    . "('ARCHER_KERNEL_RAMDISK_SIZE','This setting defines the amount of physical "
    ...
    . PXE_KERNEL_RAMDISK
    . "','TFTP Server'),"
    . "('ARCHER_USE_SLOPPY_NAME_LOOKUPS','The settings was added to workaround "
    ...
    . "address on the ARCHER server before writing the config files.','"
    . USE_SLOPPY_NAME_LOOKUPS
    . "','General Settings'),"
    . "('ARCHER_MEMTEST_KERNEL', 'The settings defines where the memtest boot "
    . "image/kernel is located.','"
    . MEMTEST_KERNEL
    . "','General Settings'),"
    . "('ARCHER_PXE_BOOT_IMAGE','The settings defines where the archer boot file "
    . "system image is located.','"
    . PXE_IMAGE
    . "','TFTP Server'),"
    . "('ARCHER_NFS_HOST','This setting defines the hostname or ip address "
    . "of the NFS server used with ARCHER.','"
    . STORAGE_HOST
    . "','NFS Server'),"
    . "('ARCHER_NFS_FTP_USERNAME','This setting defines the username "
    . "used to access files on the nfs server used with ARCHER.','"
    . STORAGE_FTP_USERNAME
    . "','NFS Server'),"
    . "('ARCHER_NFS_FTP_PASSWORD','This setting defines the password "
    . "used to access flies on the nfs server used with ARCHER.','"
    . STORAGE_FTP_PASSWORD
    . "','NFS Server'),"
    . "('ARCHER_NFS_DATADIR','This setting defines the directory on "
    . "the NFS server where images are stored.','"
    . STORAGE_DATADIR
    . "','NFS Server'),"
    . "('ARCHER_NFS_DATADIR_CAPTURE','This setting defines the directory "
    . "on the NFS server where images are captured too.','"
    . STORAGE_DATADIR_CAPTURE
    . "','NFS Server'),"
    . "('ARCHER_NFS_BANDWIDTHPATH','This setting defines the web page "
    . "used to acquire the bandwidth used by the nfs server.','"
    . STORAGE_BANDWIDTHPATH
    . "','NFS Server'),"
    . "('ARCHER_CAPTURERESIZEPCT','This setting defines the amount of "
    . "padding applied to a partition before attempting resize the "
    . "ntfs volume and capturing it.','"
    . CAPTURERESIZEPCT
    . "','General Settings'),"
    . "('ARCHER_WEB_HOST','This setting defines the hostname or ip "
    . "address of the web server used with archer.','"
    . WEB_HOST
    . "','Web Server'),"
    . "('ARCHER_WEB_ROOT','This setting defines the path to the "
    . "archer webserver\'s root directory.','"
    . '/archer/'
    . "','Web Server'),"
    . "('ARCHER_WOL_HOST','This setting defines the ip address "
    . "of hostname for the server hosting the Wake-on-lan service.','"
    . WOL_HOST
    . "','General Settings'),"
    . "('ARCHER_WOL_PATH','This setting defines the path to the files "
    . "performing the WOL tasks.','"
    . WOL_PATH
    . "','General Settings'),"
    . "('ARCHER_WOL_INTERFACE','This setting defines the network interface "
    . "used in the WOL process.','"
    . WOL_INTERFACE
    . "','General Settings'),"
    . "('ARCHER_SNAPINDIR','This setting defines the location of the "
    . "snapin files. These files must be hosted on the web server.','"
    . SNAPINDIR
    . "','Web Server'),"
    . "('ARCHER_CHECKIN_TIMEOUT','This setting defines the amount "
    . "of time between client checks to determine if they are "
    . "active clients.','"
    . CHECKIN_TIMEOUT
    . "','General Settings'),"
    . "('ARCHER_USER_MINPASSLENGTH','This setting defines the "
    . "minimum number of characters in a user\'s password.','"
    . USER_MINPASSLENGTH
    . "','User Management'),"
    . "('ARCHER_NFS_ETH_MONITOR','This setting defines which "
    . "interface is monitored for traffic summaries.','"
    . NFS_ETH_MONITOR
    . "','NFS Server'),"
    . "('ARCHER_UDPCAST_INTERFACE', 'This setting defines the "
    . "interface used in multicast communications.','"
    . UDPCAST_INTERFACE
    . "','Multicast Settings'),"
    . "('ARCHER_UDPCAST_STARTINGPORT','This setting defines the "
    ...
    . "','Multicast Settings'),"
    . "('ARCHER_MULTICAST_MAX_SESSIONS','This setting defines "
    . "the maximum number of multicast sessions that can be "
    . "running at one time.','"
    . ARCHER_MULTICAST_MAX_SESSIONS
    . "', 'Multicast Settings'),"
    . "('ARCHER_JPGRAPH_VERSION','This setting defines jpgraph version to use.','"
    . ARCHER_JPGRAPH_VERSION
    . "', 'Web Server'),"
    . "('ARCHER_REPORT_DIR','This setting defines the location on the "
    . "web server of the ARCHER reports.','"
    . ARCHER_REPORT_DIR
    . "','Web Server'),"
    . "('ARCHER_THEME','This setting defines what css style "
    . "sheet and theme to use for ARCHER.','"
    . ARCHER_THEME
    . "','Web Server'),"
    . "('ARCHER_CAPTUREIGNOREPAGEHIBER','This setting defines if you would "
    . "like to remove hibernate and swap files before capturing a "
    . "Windows image.','"
    . ARCHER_CAPTUREIGNOREPAGEHIBER
    . "','General Settings'),"
    . "('ARCHER_CLIENT_DIRECTORYCLEANER_ENABLED','This setting defines if "
    ...
    . "(Valid values: 0 or 1).','1', 'ARCHER Client - Directory Cleaner')",
    ...
    . '(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`)'
    . 'VALUES'
    . "('ARCHER_USE_ANIMATION_EFFECTS','This setting defines if the "
    . "ARCHER management portal uses animation effects on it. "
    . "Valid values are 0 or 1', '1', 'General Settings'),"
    . "('ARCHER_CLIENT_USERCLEANUP_ENABLED','This setting defines if "
    ...
    . "values are 0 or 1)','0','ARCHER Client - User Cleanup')",
    ...
    . ' (`settingKey`,`settingDesc`,`settingValue`,`settingCategory`)'
    . 'VALUES'
    . " ('ARCHER_CLIENT_GREENARCHER_ENABLED','This setting defines if the green "
    . "archer module should be enabled. The green archer module will shutdown "
    . "or restart a computer at a set time. (Valid values are 0 or 1)'"
    . ",'1','ARCHER Client - Green Archer'),"
    . "('ARCHER_CLIENT_AUTOLOGOFF_ENABLED','This setting defines if the "
    . "auto log off module should be enabled. This module will log "
    . "off any active user after X minutes of inactivity."
    . "(Valid values are 0 or 1)','1','ARCHER Client - Auto Log Off'),"
    . "('ARCHER_CLIENT_DISPLAYMANAGER_ENABLED','This setting defines "
    . "if the archer display manager should be active. The archer display "
    . "manager will reset the clients screen resolution to a fixed "
    . "size on log off and on computer start up."
    . "(Valid values are 0 or 1)','0','ARCHER Client - Display Manager'),"
    . "('ARCHER_CLIENT_DISPLAYMANAGER_X','This setting defines the default "
    . "width in pixels to reset the computer display to with the archer "
    . "display manager service.','1024','ARCHER Client - Display Manager'),"
    . "('ARCHER_CLIENT_DISPLAYMANAGER_Y','This setting defines the "
    . "default height in pixels to reset the computer display to "
    . "with the archer display manager service.','768','ARCHER Client - Display Manager'),"
    . "('ARCHER_CLIENT_DISPLAYMANAGER_R','This setting defines the "
    . "default refresh rate to reset the computer display to with "
    . "the archer display manager service.','60','ARCHER Client - Display Manager'),"
    . "('ARCHER_CLIENT_AUTOLOGOFF_BGIMAGE','This setting defines the "
    ...
    . "'c:\\\\program files\\\\archer\\\\images\\\\alo-bg.jpg',"
    . "'ARCHER Client - Auto Log Off'),"
    . "('ARCHER_CLIENT_AUTOLOGOFF_MIN','This setting defines the number of "
    . "minutes to wait before logging a user off of a PC."
    . "(Value of 0 will disable this module.)','0', 'ARCHER Client - Auto Log Off'),"
    . "('ARCHER_KEYMAP','This setting defines the keymap used on "
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_HOSTNAMECHANGER_ENABLED','This setting defines if the archer "
    . "hostname changer should be globally active. (Valid values are 0 or 1)',"
    . "'1', 'ARCHER Client - Hostname Changer')",
    "CREATE TABLE `aloLog` ("
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_SNAPIN_ENABLED','This setting defines if the "
    . "archer snapin installer should be globally active. (Valid values are 0 or 1)'"
    . ",'1', 'ARCHER Client - Snapins')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_KERNEL_ARGS', 'This setting allows you to add additional "
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_CLIENTUPDATER_ENABLED','This setting defines if "
    . "the archer client updater should be globally active. "
    . "(Valid values are 0 or 1)','1','ARCHER Client - Client Updater'),"
    . "('ARCHER_CLIENT_HOSTREGISTER_ENABLED','This setting defines if the "
    . "archer host register should be globally active. "
    . "(Valid values are 0 or 1)','1','ARCHER Client - Host Register'),"
    . "('ARCHER_CLIENT_PRINTERMANAGER_ENABLED','This setting defines if the "
    . "archer printer maanger should be globally active. "
    . "(Valid values are 0 or 1)','1','ARCHER Client - Printer Manager'),"
    . "('ARCHER_CLIENT_TASKREBOOT_ENABLED','This setting defines if the archer "
    . "task reboot should be globally active. "
    . "(Valid values are 0 or 1)','1','ARCHER Client - Task Reboot'),"
    . "('ARCHER_CLIENT_USERTRACKER_ENABLED','This setting defines if the archer "
    . "user tracker should be globally active. "
    . "(Valid values are 0 or 1)','1','ARCHER Client - User Tracker')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_AD_DEFAULT_DOMAINNAME','This setting defines the default "
    . "value to populate the host\'s Active Directory domain name value.',"
    . "'','Active Directory Defaults'),"
    . "('ARCHER_AD_DEFAULT_OU','This setting defines the default value to "
    . "populate the host\'s Active Directory OU value.',"
    . "'','Active Directory Defaults'),"
    . "('ARCHER_AD_DEFAULT_USER','This setting defines the default value to "
    . "populate the host\'s Active Directory user name value.',"
    . "'', 'Active Directory Defaults'),"
    . "('ARCHER_AD_DEFAULT_PASSWORD','This setting defines the default value "
...
$this->schema[] = array(
    ...
    . "('ARCHER_UTIL_DIR','This setting defines the location of the archer "
    . "utility directory.','/opt/archer/utils','ARCHER Utils')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_PLUGINSYS_ENABLED', 'This setting defines if the archer plugin "
    . "system should be enabled.','0','Plugin System'),"
    . "('ARCHER_PLUGINSYS_DIR','This setting defines the base location "
    . "of archer plugins.','./plugins','Plugin System')",
...
$this->schema[] = array(
    ...
    . "(`ngName`,`ngDesc`) "
    . "VALUES "
    . "('default','Auto generated archer nfs group')",
    ...
    . "VALUES "
    . "('DefaultMember','Auto generated archer nfs group member','1',"
    . "'1','/images','1','"
    . STORAGE_HOST
    . "','10','"
    . STORAGE_FTP_USERNAME
    ...
    . "('ARCHER_NFS_HOST','ARCHER_NFS_FTP_USERNAME','ARCHER_NFS_FTP_PASSWORD',"
    . "'ARCHER_NFS_DATADIR','ARCHER_NFS_DATADIR_CAPTURE')",
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_STORAGENODE_MYSQLUSER','This setting defines the username "
    . "the storage nodes should use to connect to the archer server.',"
    . "'archerstorage','ARCHER Storage Nodes')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_SSH_USERNAME','This setting defines the username used "
    . "for the ssh client.','root','SSH Client'),"
    . "('ARCHER_SSH_PORT','This setting defines the port to use for the ssh client.',"
    . "'22','SSH Client'),"
    . "('ARCHER_VIEW_DEFAULT_SCREEN','This setting defines which page is "
    . "displayed in each section, valid settings includes <b>LIST</b> "
    . "and <b>SEARCH</b>.','SEARCH','ARCHER View Settings')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_PXE_MENU_TIMEOUT','This setting defines the default value "
    . "for the pxe menu timeout.','3','ARCHER PXE Settings'),"
    . "('ARCHER_PROXY_IP','This setting defines the proxy ip address to use.',"
    . "'','General Settings'),"
    . "('ARCHER_PROXY_PORT','This setting defines the proxy port address to use.',"
    . "'','General Settings')",
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_UTIL_BASE','This setting defines the location of util base, "
    . "which is typically /opt/archer/','/opt/archer/','ARCHER Utils')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_PXE_MENU_HIDDEN','This setting defines if you would like the "
    . "ARCHER pxe menu hidden or displayed','0','ARCHER PXE Settings'),"
    . "('ARCHER_PXE_ADVANCED','This setting defines if you would like to "
    . "append any settings to the end of your PXE default file.','',"
    . "'ARCHER PXE Settings'),"
    . "('ARCHER_USE_LEGACY_TASKLIST','This setting defines if you would like to "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_QUICKREG_AUTOPOP','Enable ARCHER Quick Registration auto "
    . "population feature (0 = disabled, 1=enabled). If this feature "
    . "is enabled, ARCHER will auto populate the host settings and "
    . "automatically image the computer without any user intervention.',"
    . "'0','ARCHER Quick Registration'),"
    . "('ARCHER_QUICKREG_IMG_ID','ARCHER Quick Registration Image ID.',"
    . "'-1', 'ARCHER Quick Registration'),"
    . "('ARCHER_QUICKREG_OS_ID','ARCHER Quick Registration OS ID.',"
    . "'-1', 'ARCHER Quick Registration'),"
    . "('ARCHER_QUICKREG_SYS_NAME','ARCHER Quick Registration system name template. "
    . "Use * for the autonumber feature.', 'PC-*', 'ARCHER Quick Registration'),"
    . "('ARCHER_QUICKREG_SYS_NUMBER','ARCHER Quick Registration system name auto number.',"
    . "'1','ARCHER Quick Registration'),"
    . "('ARCHER_DEFAULT_LOCALE','Default language code to use for ARCHER.',"
    . "'en', 'General Settings'),"
    . "('ARCHER_HOST_LOCKUP','Should ARCHER attempt to see if a host is active "
    . "and display it as part of the UI?','1','General Settings'),"
    . "('ARCHER_UUID','This is a unique ID that is used to identify your "
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_QUICKREG_MAX_PENDING_MACS','This setting defines how many mac "
    . "addresses will be stored in the pending mac address table for each host.',"
    . "'4', 'ARCHER Client - Host Register'),"
    . "('ARCHER_QUICKREG_PENDING_MAC_FILTER','This is a list of MAC address "
    ...
    . "'','ARCHER Client - Host Register'),"
    . "('ARCHER_ADVANCED_STATISTICS','Enable the collection and display of "
    . "advanced statistics. This information WILL be sent to a remote "
    . "server! This information is used by the ARCHER team to see how "
    . "ARCHER is being used. The information that will be sent includes "
    . "the server\'s UUID value, the number of hosts present in ARCHER, "
    . "and number of images on your ARCHER server and well as total "
...
$this->schema[] = array(
    ...
    "UPDATE `globalSettings` set `settingKey`='ARCHER_HOST_LOOKUP' "
    . "WHERE `settingKey`='ARCHER_HOST_LOCKUP'",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_DISABLE_CHKDSK','This is an experimental feature that will "
    ...
    . "('ARCHER_CHANGE_HOSTNAME_EARLY','This is an experimental feature that "
    . "will can be used to change the computers hostname right after "
    . "imaging the box, without the need for the ARCHER service. "
...
// 29
if (ARCHER_SCHEMA < $tmpSchema->get('value')) {
    self::$DB->query(
...
$this->schema[] = array(
    ...
    . "(1,'Queued','Task has been created and ARCHER is "
    ...
    . "`ttType` enum('archer','user') NOT NULL DEFAULT 'user',"
    ...
    . "ARCHER server to the client computer with all included snapins.',"
    . "'senddebug.png', 'type=down', 'archer', '0', 'both'),"
    . "(2,'Capture','Capture will pull an image from a client computer "
    . "that will be saved on the server.','restoredebug.png',"
    . "'type=up','archer','0','host'),"
    ...
    . "'type=down mode=debug', 'archer', '1', 'host'),"
    ...
    . "'wake.png', '', 'archer', '1', 'both'),"
    . "(15, 'Deploy - Debug', 'Deploy - Debug mode allows ARCHER to "
    . "setup the environment to allow you send a specific image "
    . "to a computer, but instead of sending the image, ARCHER "
    . "will leave you at a prompt right before sending. If "
    . "you actually wish to send the image all you need to "
    . "do is type \"archer\" and hit enter.', 'senddebug.png', "
    . "'type=down mode=debug', 'archer', '1', 'host'),"
    . "(16, 'Capture - Debug', 'mode allows ARCHER to setup the "
    . "environment to allow you capture a specific image to a "
    . "computer, but instead of capturing the image, ARCHER will "
    . "leave you at a prompt right before restoring. If you "
    . "actually wish to capture the image all you need to do is "
    . "type \"archer\" and hit enter.', 'restoredebug.png', "
    . "'type=up mode=debug', 'archer', '1', 'host'),"
    . "(17, 'Deploy without Snapins', 'Deploy without snapins "
    . "allows ARCHER to image the workstation, but after the task "
    . "is complete any snapins linked to the host or group will "
    . "NOT be sent.', 'sendnosnapin.png', '', 'archer', '1', 'both'),"
...
$this->schema[] = array(
    ...
    . "you must remember to remove the PXE file, by clicking on "
    . "\"Active Tasks\" and clicking on the \"Kill Task\" button.', "
    . "'debug.png', '', 'mode=onlydebug', 'archer', '1', 'host'),"
    ...
    . "\"Kill Task\" button.', 'memtest.png', 'archer/memtest/memtest', "
    . "'', 'archer', '1', 'both'),"
    ...
    . "on the ARCHER server to the client computer with all included "
    . "snapins.', 'senddebug.png', '', 'type=down mc=yes', 'archer', "
    . "'0', 'group'),"
    . "(10, 'Hardware Inventory', 'The hardware inventory task will "
    . "boot the client computer and pull basic hardware information "
    . "from it and report it back to the ARCHER server.', "
    . "'inventory.png', '', 'mac_deployed=\${HOST_MAC} mode=autoreg "
    . "deployed=1', 'archer', '1', 'both'),"
    . "(11, 'Password Reset', 'Password reset will blank out a "
    ...
    . "(Requires ARCHER Client to be installed on client)', "
    . "'snap.png', '', '', 'archer', '1', 'both'),"
    . "(13, 'Single Snapin', 'This option allows you to send "
    . "a single snapin to a host. (Requires ARCHER Client to be "
    . "installed on client)', 'snap.png', '', '', 'archer', '1', 'both'),"
    . "(14, 'Wake-Up', 'Wake Up will attempt to send the "
    ...
    . "computer and perform a full disk wipe. This method "
    . "writes a few passes of random data to the hard disk.',"
    . "'fullwipe.png', '', 'mode=wipe wipemode=full', 'archer',"
    . "'1', 'both'),"
    ...
    . "'mode=clamav avmode=q', 'archer', '1', 'both')"
);
// 34
$this->schema[] = array(
    ...
    . "If the module is globally disabled, this setting is ignored.'),"
    . "(5,'Green ARCHER','greenarcher','This setting will enable or "
    . "disable the green archer service module on this specific host. "
    . "If the module is globally disabled, this setting is ignored.'),"
    ...
    "UPDATE `moduleStatusByHost` SET "
    . "`msModuleID`='5' WHERE `msModuleID`='greenarcher'",
    "UPDATE `moduleStatusByHost` SET "
...
$this->schema[] = array(
    ...
    . "VALUES "
    . "(1,'Queued','Task has been created and ARCHER is waiting for the Host "
    . "to check-in.','1'),"
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_PIGZ_COMP','PIGZ Compression Rating','9','ARCHER PXE Settings')",
);
// 41
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_KEY_SEQUENCE','Key Sequence for boot prompt.','0','ARCHER Boot Setting')"
);
// 44
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_LEGACY_FLAG_IN_GUI','This setting allows you to set "
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_PROXY_USERNAME','This setting defines the proxy username to use.',"
    . "'','General Settings'),"
    . "('ARCHER_PROXY_PASSWORD','This setting defines the proxy password to use.',"
    . "'','General Settings')",
    "UPDATE `globalSettings` SET `settingCategory`='Proxy Settings' "
    . "WHERE `globalSettings`.`settingKey` LIKE 'ARCHER_PROXY%'",
);
// 84
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_NO_MENU','This setting sets the system to no menu, if "
    . "there is no task set, it boots to first device.','','ARCHER Boot Settings')",
);
// 85
$this->schema[] = array(
    "UPDATE `globalSettings` SET `settingCategory`='ARCHER Boot Settings' "
    . "WHERE `settingCategory`='ARCHER PXE Settings' OR "
    . "`settingCategory`='ARCHER Boot Setting'",
);
// 86
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_TFTP_PXE_KERNEL_32','Location of the 32 bit kernel file on "
    . "the PXE server, this should point to the kernel itself.',"
    . "'bzImage32','TFTP Server'),"
    . "('ARCHER_PXE_BOOT_IMAGE_32','The settings defines where the 32 bit "
    . "archer boot file system image is located.','init_32.xz','TFTP Server')",
);
// 87 - used to be ARCHER_MINING_ENABLE but was entirely removed
$this->schema[] = array();
// 88
$this->schema[] = array(
    "ALTER TABLE `images` "
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_BOOT_EXIT_TYPE','The method of booting to the hard drive. "
    . "Most will accept sanboot, but some require exit.','','ARCHER Boot Settings')",
);
// 91 - used to be ARCHER_MINING_MAX_CORES but was entirely removed
$this->schema[] = array();
// 92
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "cryptocurrency that will be donated to the ARCHER Project.',"
    . "'donate.png','','mode=donate.full','archer','1','both')",
);
// 95 - used to be two ARCHER_MINING_* settings but were entirely removed
$this->schema[] = array();
// 96
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "WHERE `settingKey`='ARCHER_TFTP_PXE_KERNEL'",
    ...
    . "ipxe"
    . DS
    . "' WHERE settingKey = 'ARCHER_TFTP_PXE_KERNEL_DIR'",
    "UPDATE `globalSettings` set `settingValue`='init.xz' "
    . "WHERE `settingKey`='ARCHER_PXE_BOOT_IMAGE'",
    "UPDATE `globalSettings` set `settingValue`='memtest.bin' "
    . "WHERE `settingKey`='ARCHER_MEMTEST_KERNEL'",
);
// 99 - used to be ARCHER_MINING_* settings but were entirely removed
$this->schema[] = array();
// 100
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_DATA_RETURNED','This setting presents the search bar "
    . "if list has more returned than this number. "
    . "(A value of 0 disables it)','0','ARCHER View Settings')",
);
// 102
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_QUICKREG_GROUP_ASSOC','Allows a group to be assigned "
    . "during quick registration. Default is no group "
    . "assigned.','0','ARCHER Quick Registration')",
);
// 103
$this->schema[] = array(
    "INSERT IGNORE INTO `os` "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`)"
    . "VALUES "
    . "('ARCHER_ALWAYS_LOGGED_IN','This setting allows user to "
    . "be signed in all the time or not. A value of 0 "
    . "disables it.','0','Login Settings'),"
    . "('ARCHER_INACTIVITY_TIMEOUT','This setting allows user to "
    . "be signed in all the time or not. Between 1 and 24 by "
    . "hours.','1','Login Settings'),"
    . "('ARCHER_REGENERATE_TIMEOUT','This setting allows user to "
...
$this->schema[] = array(
    ...
    "UPDATE `globalSettings` SET `settingKey`='ARCHER_FORMAT_FLAG_IN_GUI' "
    . "WHERE `settingKey`='ARCHER_LEGACY_FLAG_IN_GUI'",
);
// 107
$this->schema[] = array(
    "DELETE FROM `globalSettings` WHERE `settingCategory`='SSH Client'",
    "UPDATE `globalSettings` SET "
    . "`settingCategory`='ARCHER Client - Snapins' WHERE "
    . "`settingKey`='ARCHER_SNAPINDIR'",
);
// 108
$this->schema[] = array(
    "UPDATE `globalSettings` SET `settingDesc`='This setting defines "
    . "if the archer printer manager should be globally active. "
    . "(Valid values are 0 or 1)' WHERE "
    . "`settingKey`='ARCHER_CLIENT_PRINTERMANAGER_ENABLED'",
);
// 109
$this->schema[] = array(
    "ALTER TABLE `images` "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_ADVANCED_MENU_LOGIN','This setting enforces a login "
    . "parameter to get into the advanced menu.','0','ARCHER Boot Settings')",
);
// 114
$this->schema[] = array(
    "INSERT IGNORE INTO `os` "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_TASK_FORCE_REBOOT','This setting enables or disables "
    . "the Force reboot of tasks. This only affects if users are "
    . "logged in. If users are logged in, the host will not "
    . "reboot if this is disabled.','0','ARCHER Client - Task Reboot')",
);
// 116
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_CHECKIN_TIME','This setting returns the client "
    . "service checkin times to the server.','60','ARCHER Client')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_UDPCAST_MAXWAIT','This setting sets the max time to "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_AES_ENCRYPT','This setting turns on or off the ARCHER Client "
    . "on the client machine to send the data encrypted with AES. If "
    . "you select this and you do not have the new ARCHER Client installed "
    . "on your system, the old client will be broken. This will only be "
    . "relevant if you have the ARCHER_NEW_CLIENT enabled as well.'"
    . ",'0','ARCHER Client'),"
    . "('ARCHER_NEW_CLIENT','This setting turns on or off the new client. "
    . "If this is selected, and the clients do not have the new client "
    . "installed, things should still work unless you also check "
    . "the ARCHER_AES_ENCRYPT box.','0','ARCHER Client'),"
    . "('ARCHER_CLIENT_MAXSIZE','This setting specifies the MAX size of "
    . "the archer.log before it rolls over. It will only work for new "
    . "clients.','204800000','ARCHER Client'),"
    . "('ARCHER_AES_PASS_ENCRYPT_KEY','This setting just stores the AES "
    ...
    . "client and server','7NFJUuQTYLZIoea32DsP9V6f0tbWnzMy','ARCHER Client'),"
    . "('ARCHER_AES_ADPASS_ENCRYPT_KEY','This setting just stores the AES "
    . "Encryption ADPass encryption key. It will only work for new "
    . "clients. This is the key used for encrypting ADPass in AES "
    . "format. If ARCHER_NEW_CLIENT is selected, to set the ADPass "
    ...
    . "'jPlUQRw5vLsrz8I1TuZdWDSiMFqXHtcm','ARCHER Client')",
);
// 119
...
$this->schema[] = array(
    ...
    . "VALUES "
    . "(1, 'archer.local', 'Boot from hard disk', '1','2',NULL),"
    . "(2, 'archer.memtest', 'Run Memtest86+', '0','2',NULL),"
    . "(3, 'archer.reginput', 'Perform Full Host Registration "
    . "and Inventory','0','0','mode=manreg'),"
    . "(4, 'archer.keyreg', 'Update Product Key', '0','1',NULL),"
    . "(5, 'archer.reg', 'Quick Registration and Inventory', '0','0','mode=autoreg'),"
    . "(6, 'archer.deployimage', 'Deploy Image', '0', '1',NULL),"
    . "(7, 'archer.multijoin', 'Join Multicast Session', '0','1',NULL),"
    . "(8, 'archer.quickdel', 'Quick Host Deletion','0','1',NULL),"
    . "(9, 'archer.sysinfo', 'Client System Information "
    . "(Compatibility)','0','2','mode=sysinfo'),"
    . "(10, 'archer.debug', 'Debug Mode','0','3','mode=onlydebug'),"
    . "(11, 'archer.advanced', 'Advanced Menu','0','4',NULL),"
    . "(12, 'archer.advancedlogin', 'Advanced Menu','0','5',NULL)",
    ...
    . "WHERE `pxeName`='archer.deployimage'",
    "UPDATE `pxeMenu` SET `pxeParams`='login\n"
    . "params\n"
    . "param mac0 \${net0/mac}\n"
    . "param arch \${arch}\n"
    ...
    . "isset \${net1/mac} && param mac1 \${net1/mac} || goto bootme\n"
    . "isset \${net2/mac} && param mac2 \${net2/mac} || goto bootme' "
    . "WHERE `pxeName`='archer.multijoin'",
    "UPDATE `pxeMenu` SET `pxeParams`='login\n"
    . "params\n"
    . "param mac0 \${net0/mac}\n"
    . "param arch \${arch}\n"
    ...
    . "isset \${net1/mac} && param mac1 \${net1/mac} || goto bootme\n"
    . "isset \${net2/mac} && param mac2 \${net2/mac} || goto bootme' "
    . "WHERE `pxeName`='archer.advancedlogin'",
);
// 123
$this->schema[] = array();
// 124
...
$this->schema[] = array(
    ...
    . "(`pxeID`,`pxeName`,`pxeDesc`,`pxeDefault`,`pxeRegOnly`,`pxeArgs`) "
    . "VALUES "
    . "(13, 'archer.approvehost', 'Approve This Host','0','6',NULL)",
    "UPDATE `pxeMenu` SET `pxeParams`='login\n"
    . "params\n"
    . "param mac0 \${net0/mac}\n"
    . "param arch \${arch}\n"
    ...
    . "isset \${net1/mac} && param mac1 \${net1/mac} || goto bootme\n"
    . "isset \${net2/mac} && param mac2 \${net2/mac} || goto bootme' "
    . "WHERE `pxeName`='archer.approvehost'",
);
// 130
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_DHCP_BOOTFILENAME','This setting just sets what is "
...
// 133
$snapindir = self::getSetting('ARCHER_SNAPINDIR');
if (!$snapindir) {
    $snapindir = '/opt/archer/snapins';
}
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_MEMORY_LIMIT','Default setting is the memory limit "
    . "set in php.ini.','128','General Settings'),"
    . "('ARCHER_EMAIL_ACTION','Enables email reports of image "
    . "actions as they\'re completed. Default setting is disabled.',"
    . "'0','ARCHER Email Settings'),"
    . "('ARCHER_EMAIL_ADDRESS','Email address(s) to send the reports to. "
    . "Multiple emails just separate by comma "
    . "(e.g. email1@domain.com,email2@domain2.com)','','ARCHER Email Settings'),"
    . "('ARCHER_EMAIL_BINARY','Path and arguments to the emailing binary "
    . "php should use for the mail function. Default is "
    . "\'/usr/sbin/sendmail -t -f noreply@\$\{server-name\}.com "
    . "-i\'','/usr/sbin/sendmail -t -f "
    . "noreply@\$\{server-name\}.com -i','ARCHER Email Settings'),"
    . "('ARCHER_FROM_EMAIL','Email from address. Default is archerserver. "
    . "\$\{server-name\} is set to the node name.',"
    . "'noreply@\$\{server-name\}.com','ARCHER Email Settings')",
);
// 140
$this->schema[] = self::fastmerge(
    array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_PXE_HIDDENMENU_TIMEOUT', 'This setting defines the default "
    . "value for the pxe hidden menu timeout.', '3', 'ARCHER Boot Settings')",
);
// 142
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_USED_TASKS', 'This setting defines tasks to consider "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_GRACE_TIMEOUT', 'This setting defines the grace period "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_SNAPIN_LIMIT', 'This setting defines the maximum snapins "
...
// 150
$this->schema[] = array(
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_JPGRAPH_VERSION'",
);
// 151
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_FTP_IMAGE_SIZE', 'This setting defines the global enabling "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_MULTICAST_ADDRESS','This setting defines an alternate "
    . "Multicast Address. Default is 0 which means disabled, value "
    . "will be ip validated if entered.','0','Multicast Settings'),"
    . "('ARCHER_MULTICAST_PORT_OVERRIDE','This setting defines an "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_MULTICAST_DUPLEX','This setting defines the duplex value. "
    . "Default is FULL_DUPLEX.','--full-duplex','Multicast Settings')",
);
// 156
$this->schema[] = array(
    "UPDATE `globalSettings` SET `settingValue`='default/archer.css' "
    . "WHERE `settingKey`='ARCHER_THEME'",
);
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_REGISTRATION_ENABLED','This setting enables the capabilities "
    . "to allow registration to occur or not. Default setting is enabled.',"
    . "'1','ARCHER Boot Settings')",
);
// 166
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_TZ_INFO','This setting allows the user to set the "
    . "system timezone. Default is UTC in the db, but will first "
    . "try the ini set if possible.','UTC','General Settings')",
);
// 167
$this->schema[] = array(
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_AES_PASS_ENCRYPT_KEY'",
);
// 168
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_KERNEL_DEBUG','This setting allows the user to have the "
    . "kernel debug flag set. Default is off.','0','ARCHER Boot Settings')",
);
// 169
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_KERNEL_LOGLEVEL','This setting allows the user to specify "
    . "which loglevel the want. Default is 4.','4','ARCHER Boot Settings')",
);
// 170
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_FTP_PORT','This setting allows the user to specify the "
    . "ftp port to be used. Default Value is port 21.',"
    . "'21','General Settings'),"
    . "('ARCHER_FTP_TIMEOUT','This setting allows the user to specify "
...
// 172
$this->schema[] = array(
    "DELETE FROM globalSettings WHERE settingKey='ARCHER_AES_ADPASS_ENCRYPT_KEY'",
);
// 173
$this->schema[] = array(
    "ALTER TABLE `greenArcher` DROP INDEX `gfHostID`",
);
// 174
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_AD_DEFAULT_PASSWORD_LEGACY','This setting defines the "
    . "default value to populate the hosts Active Directory "
    . "password value but only uses the old ARCHERCrypt method "
    . "of encryption. This setting must be encrypted. The "
    . "ARCHER_NEW_CLIENT setting will determine if it is going "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_NONREG_DEVICE','This setting defines a target disk to "
...
// 180
$this->schema[] = array(
    "UPDATE globalSettings SET settingValue=6 WHERE settingKey='ARCHER_PIGZ_COMP'",
);
// 181
$this->schema[] = array(
    "INSERT IGNORE INTO `os` "
...
// 186
$this->schema[] = array(
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_NEW_CLIENT'",
    ...
    . "but only uses the old ARCHERCrypt method of encryption. "
    . "This setting must be encrypted before stored.' "
    . "WHERE `settingKey`='ARCHER_AD_DEFAULT_PASSWORD_LEGACY'",
    "UPDATE `globalSettings` SET "
    . "`settingDesc`='This setting defines the default value "
    ...
    . "WHERE `settingKey`='ARCHER_AD_DEFAULT_PASSWORD'",
);
// 187
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    "UPDATE `nfsGroupMembers` SET `ngmWebroot`='/archer/'",
);
// 189
$this->schema[] = self::fastmerge(
    $tmpSchema->dropDuplicateData(
    ...
    array("DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_WOL_PATH'",
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_WOL_HOST'",
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_WOL_INTERFACE'")
);
// 190
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_EFI_BOOT_EXIT_TYPE','The method (U)EFI uses to boot the "
    . "next boot entry/hard drive. Most will require exit. (Default REFIND)',"
    . "'refind_efi','ARCHER Boot Settings')",
);
// 193
$this->schema[] = array(
...
// 199
$this->schema[] = array(
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_AES_ENCRYPT'",
    "DELETE FROM `globalSettings` WHERE `settingKey`='ARCHER_DHCP_BOOTFILENAME'",
);
// 200
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "linux side archer services. (Default /opt/archer/log/)',"
    . "'/opt/archer/log/','ARCHER Linux Service Logs'),"
    . "('SERVICE_LOG_SIZE','The maximum size for logs before "
    . "starting new in bytes (Default 1000000)','1000000','ARCHER Linux Service Logs'),"
    . "('MULTICASTLOGFILENAME','Filename to store the multicast log file to "
    . "(Default multicast.log)','multicast.log','ARCHER Linux Service Logs'),"
    . "('IMAGEREPLICATORLOGFILENAME','Filename to store the image "
    . "replicator log file to (Default archerreplicator.log)',"
    . "'archerreplicator.log','ARCHER Linux Service Logs'),"
    . "('SNAPINREPLICATORLOGFILENAME','Filename to store the snapin "
    . "replicator log file to (Default archersnapinrep.log)',"
    . "'archersnapinrep.log','ARCHER Linux Service Logs'),"
    . "('SNAPINHASHLOGFILENAME','Filename to store the snapin hash log "
    . "file to (Default archersnapinhash.log)','archersnapinhash.log',"
    . "'ARCHER Linux Service Logs'),"
    . "('SCHEDULERLOGFILENAME','Filename to store the scheduled "
    . "tasks log file to (Default archerscheduled.log)',"
    . "'archerscheduler.log','ARCHER Linux Service Logs'),"
    . "('SERVICEMASTERLOGFILENAME','Filename to store "
    . "the service master log file to (Default servicemaster.log)',"
    . "'servicemaster.log','ARCHER Linux Service Logs'),"
    . "('PINGHOSTLOGFILENAME','Filename to store the ping host log "
    . "file to (Default pinghost.log)','pinghost.log','ARCHER Linux Service Logs'),"
    . "('PINGHOSTSLEEPTIME','The amount of time between ping host service runs. "
    . "Value is in seconds. (Default 300)','300','ARCHER Linux Service Sleep Times'),"
    ...
    . "(Default /dev/tty6)','/dev/tty6','ARCHER Linux Service TTY Output')",
);
// 207
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_WIPE_TIMEOUT', 'This setting defines the number of "
    . "seconds to wait for wiping disks. (Default 60)',"
    . "'60', 'ARCHER Boot Settings')",
);
// 208
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_BANDWIDTH_TIME', 'This setting defines how often to "
...
$this->schema[] = array(
    ...
    "UPDATE `nfsGroupMembers` SET `ngmSSLPath`='/opt/archer/snapins/ssl'",
);
// 213
$this->schema[] = array(
    ...
    . "`settingKey` IN ('ARCHER_TORRENT_INTERVAL',"
    . "'ARCHER_TORRENT_TIMEOUT','ARCHER_TORRENT_INTERVAL_MIN',"
    . "'ARCHER_TORRENT_PPR','ARCHER_TORRENTDIR')",
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_ENFORCE_HOST_CHANGES','This setting only operates with "
    . "the new client. Default value is 1 which allows the new "
    . "client to enforce name changing on every cycle it checks "
    . "in, so any change on ARCHER will take place on the next cycle. "
...
$this->schema[] = array(
    ...
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_AUTOUPDATE','This setting lets the admin choose "
    . "whether or not the clients on the hosts will be able to auto "
    . "update. Default is enabled.',1,'ARCHER Client')",
    "UPDATE `globalSettings` SET "
    . "`settingCategory`=REPLACE(`settingCategory`,'ARCHER Service','ARCHER Client') "
    . "WHERE `settingCategory` LIKE '%ARCHER Service%'",
    "UPDATE `globalSettings` SET "
    . "`settingCategory`=REPLACE(`settingCategory`,'ARCHER Linux Service',"
    . "'ARCHER Service') WHERE `settingCategory` LIKE '%ARCHER Linux Service%'",
    "UPDATE `globalSettings` SET "
    . "`settingKey`=REPLACE(`settingKey`,'ARCHER_SERVICE','ARCHER_CLIENT') "
    . "WHERE `settingKey` LIKE '%ARCHER_SERVICE%'",
);
// 219
$this->schema[] = array(
);
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_POWERMANAGEMENT_ENABLED', 'This setting defines if "
    ...
    . "'1','ARCHER Client - Power Management')",
);
// 224
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`,`settingDesc`,`settingValue`,`settingCategory`) "
    . "VALUES "
    . "('ARCHER_IPXE_MAIN_COLOURS','This setting allows the admin to "
    ...
    . "||','ARCHER Boot Settings'),"
    . "('ARCHER_IPXE_MAIN_CPAIRS','This setting allows the admin "
    ...
    . "ARCHER_IPXE_MAIN_FALLBACK_CPAIRS','cpair --foreground 7 "
    . "--background 2 2 ||','ARCHER Boot Settings'),"
    . "('ARCHER_IPXE_MAIN_FALLBACK_CPAIRS','This setting allows "
    ...
    . "'ARCHER Boot Settings'),"
    . "('ARCHER_IPXE_VALID_HOST_COLOURS','This setting allows the "
    ...
    . "items.','colour --rgb 0x00567a 0 ||','ARCHER Boot Settings'),"
    . "('ARCHER_IPXE_INVALID_HOST_COLOURS','This setting allows the "
    ...
    . "'colour --rgb 0xff0000 0 ||','ARCHER Boot Settings'),"
    . "('ARCHER_IPXE_HOST_CPAIRS','This setting allows the admin "
    . "to define their own cpair elements for the iPXE Boot "
    . "Menu of the host information. Each element must have "
    . "a new line as a separator for multiple items.',"
    . "'cpair --foreground 1 1 ||\ncpair --foreground 0 3 "
    . "||\ncpair --foreground 4 4 ||','ARCHER Boot Settings'),"
    . "('ARCHER_IPXE_BG_FILE','This setting allows the admin to "
    . "define their own background file. Files will need to "
    . "be in the archer web root under service/ipxe. Default "
    . "file is bg.png.','bg.png','ARCHER Boot Settings')",
);
// 225
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "saved on the ARCHER server to the client computer with "
    ...
    "UPDATE `taskTypes` SET "
    . "`ttDescription`='Deploy - Debug mode allows ARCHER to "
    . "setup the environment to allow you send a specific "
    . "image to a computer, but instead of sending the "
    . "image, ARCHER will leave you at a prompt right before "
    . "sending. If you actually wish to send the image all "
    . "you need to do is type \"archer\" and hit enter.' WHERE `ttID`=15",
    "UPDATE `taskTypes` SET "
    . "`ttDescription`='Capture - Debug mode allows ARCHER to "
    . "setup the environment to allow you capture a specific "
    . "image from a computer, but instead of capturing the image, "
    . "ARCHER will leave you at a prompt right before restoring. "
    . "If you actually wish to capture the image all you need "
    . "to do is type \"archer\" and hit enter.' WHERE `ttID`=16",
    "UPDATE `taskTypes` SET `ttDescription`='Deploy without "
    . "snapins allows ARCHER to image the workstation, but after "
    . "the task is complete any snapins linked to the host or "
    . "group will NOT be sent.' WHERE `ttID`=17",
    "UPDATE `pxeMenu` SET `pxeName`='archer.deployimage',"
    . "`pxeDesc`='Deploy Image' WHERE `pxeName`='archer.quickimage'"
);
// 231
$this->schema[] = array(
    "DELETE FROM `moduleStatusByHost` WHERE `msState`='0'",
...
$this->schema[] = array(
    "UPDATE `globalSettings` SET "
    . "`settingKey`='ARCHER_CAPTUREIGNOREPAGEHIBER' "
    . "WHERE `settingKey`='ARCHER_UPLOADIGNOREPAGEHIBER'",
    "UPDATE `globalSettings` SET `settingKey`='ARCHER_CAPTURERESIZEPCT' "
    . "WHERE `settingKey`='ARCHER_UPLOADRESIZEPCT'",
);
// 234
$this->schema[] = array(
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_URL_AVAILABLE_TIMEOUT', 'This setting defines the available timeout in "
    . "thousandths of a second. (Default is 2000 milliseconds)',"
    . "'2000','General Settings'),"
    . "('ARCHER_URL_BASE_CONNECT_TIMEOUT', 'This setting defines the available timeout "
    . "to connect to a server to perform real actions.  This is set in seconds. "
    . "(Default is 15 seconds)','15','General Settings'),"
    . "('ARCHER_URL_BASE_TIMEOUT', 'This setting defines the total timeout to perform "
...
$this->schema[] = array(
    ...
    . "'ARCHER Linux Service Logs' WHERE `settingCategory`="
    . "'ARCHER Service Logs'",
    "UPDATE `globalSettings` SET `settingCategory`="
    . "'ARCHER Linux Service Sleep Times' WHERE `settingCategory`="
    . "'ARCHER Service Sleep Times'",
    "UPDATE `globalSettings` SET `settingCategory`="
    . "'ARCHER Linux Service TTY Output' WHERE `settingCategory`="
    . "'ARCHER Service TTY Output'"
);
// 240
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_CLIENT_BANNER_IMAGE', 'This setting defines an image for"
    . " the banner on the archer client.','','Rebranding'),"
    . "('ARCHER_CLIENT_BANNER_SHA', 'This setting stores the sha value of"
    . " the banner to be applied.','','Rebranding'),"
    . "('ARCHER_COMPANY_NAME', 'This setting defines the name you"
    . " would like presented on the client.','','Rebranding'),"
    . "('ARCHER_COMPANY_COLOR', 'This setting is the hex color code"
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_COMPANY_TOS','This allows setting the company terms of service.',"
    . "'', 'Rebranding'),"
    . "('ARCHER_COMPANY_SUBNAME','This allows setting the company sub unit.',"
    . "'', 'Rebranding')",
    "UPDATE `globalSettings` SET `settingCategory`='Rebranding' WHERE "
    . "`settingKey` IN ('ARCHER_CLIENT_BANNER_IMAGE','ARCHER_CLIENT_BANNER_SHA',"
    . "'ARCHER_COMPANY_NAME','ARCHER_COMPANY_COLOR')"
);
// 242
$this->schema[] = array(
    "UPDATE `globalSettings` SET `settingKey`='ARCHER_COMPANY_NAME' WHERE "
    . "`settingKey`='ARCHER_COMPANY_NAME'",
    "UPDATE `globalSettings` SET `settingKey`='ARCHER_COMPANY_SUBNAME',"
    . "`settingDesc`='This allows setting the sub unit, and is only used "
    . " on the Equipment loan report for tracking.' WHERE "
    . "`settingKey`='ARCHER_COMPANY_SUBNAME'",
    "UPDATE `globalSettings` SET `settingKey`='ARCHER_COMPANY_COLOR' WHERE "
    . "`settingKey`='ARCHER_COMPANY_COLOR'",
    "UPDATE `globalSettings` SET `settingDesc`='This setting defines an image "
    . "for the banner on the archer client. The width must be 650 pixels, and "
    . "the height must be 120 pixels.' WHERE `settingKey`='ARCHER_CLIENT_BANNER_IMAGE'"
);
// 243
$this->schema[] = array(
    "INSERT IGNORE INTO `globalSettings` "
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_LOGIN_INFO_DISPLAY', 'This setting defines if the login page"
    . " should or should not display archer version information. (Default is "
...
$this->schema[] = array(
    ...
    . "'1','ARCHER Linux Service Enabled'),"
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_MULTICAST_RENDEZVOUS', 'This setting defines a rendez-vous"
...
$this->schema[] = array(
    ...
    . "'3600','ARCHER Linux Service Sleep Times'),"
    . "('IMAGESIZELOGFILENAME','Filename to store the image size log "
    . "file to (Default archerimagesize.log)','archerimagesize.log',"
    . "'ARCHER Linux Service Logs'),"
...
$this->schema[] = array(
    ...
    . "(`settingKey`, `settingDesc`, `settingValue`, `settingCategory`) "
    . "VALUES "
    . "('ARCHER_QUICKREG_PROD_KEY_BIOS','Try pulling systems SLIC product key."
...
$this->schema[] = array(
    "UPDATE `globalSettings` SET `settingValue`='"
    . STORAGE_FTP_USERNAME
    . "' WHERE settingKey='ARCHER_TFTP_FTP_USERNAME'",
    "UPDATE `nfsGroupMembers` SET `ngmUser`='"
    . STORAGE_FTP_USERNAME
    . "' WHERE ngmHostname='"
    . STORAGE_HOST
...
// 267
$this->schema[] = array(
    "UPDATE `globalSettings` SET `settingValue`=275000 WHERE settingKey='ARCHER_KERNEL_RAMDISK_SIZE'"
);
// 268
$this->schema[] = array(
    "UPDATE `globalSettings` SET "
    ...
    . "WHERE `settingKey`='ARCHER_EMAIL_ADDRESS'"
);
