 ...
 * @link     https://archer.umax.uz
 */
class DashboardPage extends ARCHERPage
{
    /**
     * The tftp variable.
     *
    ...
    {
        $this->name = self::$archerlang['Dashboard'];
    ...
    public function index()
    {
        ...
        $SystemUptime = self::$ARCHERCore->systemUptime();
        $fields = array(
            _('Username') => self::$ARCHERUser->get('name'),
        ...
        echo '</div>';
        echo '<div class="panel-body">';
        echo '<div class="graph pie-graph archerdashbox" id="graph-activity"></div>';
        ...
        echo '<div class="graph pie-graph archerdashbox" id="graph-diskusage"></div>';
        echo '</a>';
        ...
        echo '</div>';
        echo '<div class="panel-body">';
        echo '<div id="graph-30day" class="graph archerdashbox"></div>';
        echo '<div class="archer-variable" id="Graph30dayData"></div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        echo '<div class="panel-heading">';
        echo '<h4 class="title">';
        echo self::$archerlang['Bandwidth'];
        echo '</h4>';
        ...
        echo '</div>';
        echo '<div class="panel-body">';
        echo '<div id="graph-bandwidth" class="graph archerdashbox"></div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
    ...
    {
        $url = sprintf(
            '%s://%s/archer/status/freespace.php?path=%s',
            self::$httpproto,
            $this->obj->get('ip'),
    ...
    public function bandwidth()
    {
        ...
        $datas = self::$ARCHERURLRequests->process($urls);
        $dataSet = [];
    ...
    public function testUrls()
    {
        ...
        $tests = self::$ARCHERURLRequests->isAvailable($testurls, 1);
        unset($testurls);
