 ...
 * @link     https://archer.umax.uz
 */
class GroupManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        if ($id) {
            ...
            $this->notes = array(
                self::$archerlang['Group'] => $this->obj->get('name'),
                self::$archerlang['Members'] => $this->obj->getHostCount(),
            );
        }
    ...
    public function groupService()
    {
        ...
        echo '<div class="panel-heading text-center">';
        echo '<h4 class="title">';
        echo _('Group ARCHER Client Module configuration');
        echo '</h4>';
        echo '</div>';
        echo '<div class="panel-body">';
        echo '<form class="form-horizontal" method="post" action="'
    ...
    public function inventory()
    {
        ...
        $_SESSION['archerlastreport'] = serialize($this->ReportMaker);
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
