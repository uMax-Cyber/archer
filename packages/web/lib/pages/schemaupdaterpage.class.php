 ...
 * @link     https://archer.umax.uz
 */
class SchemaUpdaterPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        $schema = new Schema(1);
        if ($schema->get('version') >= ARCHER_SCHEMA) {
    ...
    public function index()
    {
        ...
        printf(
            ...
            _('ARCHER database you can do so using'),
        ...
        echo '<pre>';
        echo 'mysqldump --allow-keywords -x -v archer > archerbackup.sql</p</pre>';
        echo '</div>';
        echo '</div>';
        printf(
            '%s, %s %s. %s, %s %s %s. %s, %s %s.',
            _('Your ARCHER database schema is not up to date'),
            _('either because you have updated'),
            _('or this is a new ARCHER installation'),
            _('If this is an upgrade'),
            _('there will be a database backup stored on your'),
            _('ARCHER server defaulting under the folder'),
            '/home/archerDBbackups',
        ...
        printf(
            ...
            _('install or update the ARCHER database')
        );
        echo '<br/>';
        echo '<br/>';
        ...
        echo '<input type="hidden" name="archerverified"/>';
