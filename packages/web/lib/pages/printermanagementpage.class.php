 ...
 * @link     https://archer.umax.uz
 */
class PrinterManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        if ($id) {
            ...
            $this->subMenu = array(
                "$this->linkformat#$this->node-gen" => self::$archerlang['General'],
                $this->membership => self::$archerlang['Membership'],
                $this->delformat => self::$archerlang['Delete'],
            );
            $this->notes = array(
                self::$archerlang['Printer'] => $this->obj->get('name'),
                self::$archerlang['Type'] => $this->_config,
            );
        }
        self::$HookManager
            ->processEvent(
