 ...
 * @link     https://archer.umax.uz
 */
class ReportManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        $_SESSION['archerlastreport'] = null;
    ...
    {
        $this->title = _('Import ARCHER Reports');
        unset(
            $this->data,
            $this->form,
            $this->headerData,
    ...
    {
        $this->title = _('About ARCHER Reports');
        echo '<div class="col-xs-9">';
        echo '<div class="panel panel-info">';
        echo '<div class="panel-heading text-center">';
        echo '<h4 class="title">';
        ...
        echo '</div>';
        echo '<div class="panel-body">';
        echo _('ARCHER Reports exist to give you information about what')
            . ' '
            . _('is going on with your ARCHER System')
            . '. '
