<?php
/**
 * Sends the printer information for the ARCHER Client
 *
 * PHP version 5
 *
 ...
 * @link     https://archer.umax.uz
 */
class PrinterClient extends ARCHERClient implements ARCHERClientSend
{
    /**
     ...
     * The available modes
     * 0 = no management
     * a = ARCHER Managed only
     * ar = ARCHER Handles all printers
     *
     * @var array
     */
