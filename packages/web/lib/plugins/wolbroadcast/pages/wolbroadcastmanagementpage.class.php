 ...
 * @link     https://archer.umax.uz
 */
class WOLBroadcastManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        self::$archerlang['ExportWolbroadcast'] = _('Export WOLBroadcasts');
        self::$archerlang['ImportWolbroadcast'] = _('Import WOLBroadcasts');
        parent::__construct($this->name);
        global $id;
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#wol-general" => self::$archerlang['General'],
