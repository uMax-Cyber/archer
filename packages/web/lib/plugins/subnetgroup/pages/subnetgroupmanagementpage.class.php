 ...
 * @link     https://archer.umax.uz
 */
class SubnetgroupManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        self::$archerlang['ExportSubnetgroup'] = _('Export Subnetgroups');
        self::$archerlang['ImportSubnetgroup'] = _('Import Subnetgroups');

        parent::__construct($this->name);
        global $id;
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#subnetgroup-general" => self::$archerlang['General'],
