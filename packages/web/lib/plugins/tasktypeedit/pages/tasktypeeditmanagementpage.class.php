 ...
 * @link     https://archer.umax.uz
 */
class TasktypeeditManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        self::$archerlang['ExportTasktypeedit'] = _('Export Task Types');
        self::$archerlang['ImportTasktypeedit'] = _('Import Task Types');
        parent::__construct($this->name);
        $this->menu['list'] = sprintf(self::$archerlang['ListAll'], _('Task Types'));
        $this->menu['add'] = sprintf(self::$archerlang['CreateNew'], _('Task Type'));
        global $id;
        global $sub;
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#tasktype-gen" => self::$archerlang['General'],
