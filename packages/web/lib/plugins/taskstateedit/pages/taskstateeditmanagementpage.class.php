 ...
 * @link     https://archer.umax.uz
 */
class TaskstateeditManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        self::$archerlang['ExportTaskstateedit'] = _('Export Task States');
        self::$archerlang['ImportTaskstateedit'] = _('Import Task States');
        parent::__construct($this->name);
        $this->menu['list'] = sprintf(self::$archerlang['ListAll'], _('Task States'));
        $this->menu['add'] = sprintf(self::$archerlang['CreateNew'], _('Task State'));
        global $id;
        global $sub;
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#taskstate-gen" => self::$archerlang['General'],
