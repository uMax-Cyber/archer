 ...
 * @link     https://archer.umax.uz
 */
class PersistentGroupsManager extends ARCHERManagerController
{
    /**
    ...
    public function install()
    {
        ...
        SET @myDBTest = (SELECT count(`table_name`) FROM information_schema.tables WHERE `table_schema` = 'archer' AND `table_name` = 'locationAssoc' LIMIT 1);
        if (@myDBTest > 0) THEN
