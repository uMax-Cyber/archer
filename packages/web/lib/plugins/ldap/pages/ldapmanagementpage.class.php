 ...
 * @link     https://archer.umax.uz
 */
class LDAPManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        self::$archerlang['ExportLdap'] = _('Export LDAPs');
        self::$archerlang['ImportLdap'] = _('Import LDAPs');
        ...
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#ldap-gen" => self::$archerlang['General'],
    ...
    public function PluginConfiguration()
    {
        ...
        $filter = self::getSetting('ARCHER_USER_FILTER');
    ...
    public function PluginConfigurationPost()
    {
        ...
        try {
            if (in_array(false, array_map(function ($v) {
                ...
                self::setSetting('ARCHER_USER_FILTER', $filter);
                $msg = json_encode(
                    array(
