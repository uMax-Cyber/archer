 ...
 * @link     https://archer.umax.uz
 */
class WindowsKeyManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        global $sub;
        global $id;
        self::$archerlang['ExportWindowskey'] = _('Export Windows Keys');
        self::$archerlang['ImportWindowskey'] = _('Import Windows Keys');
        parent::__construct($this->name);
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#windowskey-gen" => self::$archerlang['General'],
