 ...
 * @link     https://archer.umax.uz
 */
class LocationManagementPage extends ARCHERPage
{
    /**
    ...
    public function __construct($name = '')
    {
        ...
        self::$archerlang['ExportLocation'] = _('Export Locations');
        self::$archerlang['ImportLocation'] = _('Import Locations');
        parent::__construct($this->name);
        global $id;
        if ($id) {
            $this->subMenu = array(
                "$this->linkformat#location-gen" => self::$archerlang['General'],
                $this->membership => self::$archerlang['Membership'],
                "$this->delformat" => self::$archerlang['Delete'],
            );
            $this->notes = array(
                self::$archerlang['Location'] => $this->obj->get('name'),
                sprintf(
                    '%s %s',
