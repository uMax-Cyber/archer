 ...
 * @link     https://archer.umax.uz
 */
class AccessControlManagementPage extends ARCHERPage
{
    ...
    public function __construct($name = '')
    {
        ...
        global $sub;
        global $id;
        self::$archerlang['ExportAccesscontrol'] = _('Export Accesscontrols');
        self::$archerlang['ImportAccesscontrol'] = _('Import Accesscontrols');
        /**
        ...
        case 'delete':
            ...
            if ($id) {
                $this->subMenu = array(
                    "$this->linkformat#role-general" => self::$archerlang['General'],
                    $this->membership => self::$archerlang['Members'],
                    sprintf(
                        '?node=%s&sub=%s&id=%s',
                        $this->node,
                        'assocRule',
        ...
        case 'deleteRule':
            ...
            if ($id) {
                ...
                $this->subMenu = array(
                    "$this->linkformat" => self::$archerlang['General'],
                    sprintf(
                        '?node=%s&sub=%s&id=%s',
                        $this->node,
                        'deleteRule',
