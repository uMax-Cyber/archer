 ...
 * @link     https://archer.umax.uz
 */
class ARCHERPageManager extends ARCHERBase
{
    /**
     ...
     * @return object
     */
    public function getARCHERPageClass()
    {
     ...
     * @return string
     */
    public function getARCHERPageName()
    {
        return $this->getARCHERPageClass()
            ->name;
    }
    /**
     * Gets the page title
     ...
     * @return string
     */
    public function getARCHERPageTitle()
    {
        return $this->getARCHERPageClass()
            ->title;
    }
    ...
    public function getSideMenu()
    {
        ...
        $class = $this->getARCHERPageClass();
        self::$ARCHERSubMenu = self::getClass('ARCHERSubMenu');
        return self::$ARCHERSubMenu->get($this->classValue);
    }
    /**
    ...
    public function render()
    {
        ...
        try {
            ...
            if (!array_key_exists($this->classValue, $this->_nodes)) {
                throw new Exception(_('No ARCHERPage Class found for this node'));
            }
    ...
    private function _register($class)
    {
        ...
        try {
            if (!($class instanceof ARCHERPage)) {
                throw new Exception(self::$archerlang['NotExtended']);
            }
            if (!$class->node) {
