 ...
 * @link     https://archer.umax.uz
 */
class HostManager extends ARCHERManagerController
{
    /**
     * The base table name.
     *
    ...
    public function getHostByMacAddresses($macs)
    {
        ...
        if (count($MACHost) > 1) {
            ...
            if (count($MACHost) > 1) {
                throw new Exception(self::$archerlang['ErrorMultipleHosts']);
            }
        }
    ...
    public function destroy(
        ...
        /*
         * Remove any green archer entries
         */
        self::getClass('GreenArcherManager')->destroy($findWhere);
        /*
