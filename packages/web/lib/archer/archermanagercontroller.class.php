<?php
/**
 * ARCHER Manager Controller, main object mass getter.
 *
 * PHP version 5
 *
 * @category ARCHERManagerController
 ...
 * @link     https://archer.umax.uz
 */
abstract class ARCHERManagerController extends ARCHERBase
{
    /**
    ...
    public function buildSelectBox(
        ...
        $tmpStr .= '<select class="form-control input-group" name="'
            ...
            . '" autocomplete="off">';
        $tmpStr .= '<option value="">- ';
        $tmpStr .= self::$archerlang['PleaseSelect'];
        $tmpStr .= ' -</option>';
        $tmpStr .= $objOpts;
        $tmpStr .= '</select>';
        return $tmpStr;
