 ...
 * @link     https://archer.umax.uz
 */
class Service extends ARCHERController
{
    /**
    ...
    public function addDir($dir)
    {
        ...
        if ($dircount > 0) {
            throw new Exception(self::$archerlang['n/a']);
        }
    ...
    public function setDisplay(
        ...
        $keySettings = array(
            'ARCHER_CLIENT_DISPLAYMANAGER_X' => $x,
            'ARCHER_CLIENT_DISPLAYMANAGER_Y' => $y,
            'ARCHER_CLIENT_DISPLAYMANAGER_R' => $r,
        );
     ...
     * @return void
     */
    public function setGreenArcher($h, $m, $t)
    {
        ...
        if ($gfcount > 0) {
            throw new Exception(self::$archerlang['TimeExists']);
        } else {
            self::getClass('GreenArcher')
                ->set('hour', $h)
                ->set('min', $m)
                ->set('action', $t)
                ->save();
    ...
    /**
     * Removes green archer.
     *
     * @param int $gf The green archer to remove
     *
     * @return void
     */
    ...
    public function addUser($user)
    {
        ...
        if ($usercount > 0) {
            throw new Exception(self::$archerlang['UserExists']);
        }
