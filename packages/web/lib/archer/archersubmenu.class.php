 ...
 * @link     https://archer.umax.uz
 */
class ARCHERSubMenu extends ARCHERBase
{
    /**
     * Stores the title.
     *
    ...
    public function addMainItems(
        ...
        if (!$ifVariable) {
            $variableSetter = self::$archerlang['MainMenu'];
        } else {
            ...
            foreach ((array) $this->items[$node] as $title => &$data) {
                ...
                foreach ((array) $data as $label => &$link) {
                    ...
                    if ($this->isExternalLink($link)) {
                        ...
                        if (!$sub || $title == self::$archerlang['MainMenu']) {
                            echo str_replace(
                                '${hash}',
                                (
                                    $hash ?
