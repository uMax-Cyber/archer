 ...
 * @link     https://archer.umax.uz
 */
class ARCHERCore extends ARCHERBase
{
    /**
    ...
    public static function setEnv()
    {
        ...
        $getSettings = array(
            'ARCHER_DEFAULT_LOCALE',
            'ARCHER_HOST_LOOKUP',
            'ARCHER_MEMORY_LIMIT',
            'ARCHER_REAUTH_ON_DELETE',
            'ARCHER_REAUTH_ON_EXPORT',
            'ARCHER_TZ_INFO',
            'ARCHER_VIEW_DEFAULT_SCREEN',
        );
        list(
            $locale,
            $hostLookup,
        ...
        self::$archerpingactive = $hostLookup;
        self::$archerdeleteactive = $authdelete;
        self::$archerexportactive = $authexport;
