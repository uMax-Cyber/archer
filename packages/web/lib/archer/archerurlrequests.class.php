 ...
 * @link     https://archer.umax.uz
 */
class ARCHERURLRequests extends ARCHERBase
{
    /**
    ...
    public function __construct($callback = null)
    {
        ...
        list(
            ...
            array(
                'name' => array(
                    'ARCHER_URL_AVAILABLE_TIMEOUT',
                    'ARCHER_URL_BASE_CONNECT_TIMEOUT',
                    'ARCHER_URL_BASE_TIMEOUT'
                )
            ),
            'value',
            false,
     ...
     *
     * @param ARCHERRollingURL $request the request to add
     *
     * @return object
     */
    ...
    public function request(
        ...
        $this->_requests[] = new ARCHERRollingURL(
            $url,
            $method,
            $postData,
            $headers,
     ...
     *
     * @param ARCHERRollingURL $request the request to get options from
     *
     * @return array
     */
    private function _getOptions($request)
    {
        ...
        list($ip, $password, $port, $username) = self::getSubObjectIDs(
            ...
            array(
                'name' => array(
                    'ARCHER_PROXY_IP',
                    'ARCHER_PROXY_PASSWORD',
                    'ARCHER_PROXY_PORT',
                    'ARCHER_PROXY_USERNAME',
                ),
            ),
            'value',
            false,
