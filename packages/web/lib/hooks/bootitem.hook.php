...
class BootItem extends Hook
{
    ...
    public function tweakmenu($arguments)
    {
         ...
         * item-<label-name>  so archer.local has item value of: item-archer.local
        ...
        foreach ((array)self::getClass('PXEMenuOptionsManager')
            ...
            if ($arguments['ipxe']['item-'.$Menu->get('name')]
                && $Menu->get('name') == 'archer.local'
            ) {
                $arguments['ipxe']['item-archer.local'][0]
                    = 'item archer.local THIS BOOTS TO DISK';
            }
            /**
            ...
            if ($arguments['ipxe']['choice-'.$Menu->get('name')]
                ...
                $arguments['ipxe']['choice-archer.local'][0]
                    = ':archer.local';
                $arguments['ipxe']['choice-archer.local'][1]
