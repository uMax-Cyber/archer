<?php
/**
 * Database Manager Handles communication from archer to db class.
 *
 * PHP version 5
 *
 * This is what communicates with archer to the db class.
 *
 ...
 * @link     https://archer.umax.uz
 */
class DatabaseManager extends ARCHERCore
{
    /**
    ...
    public static function establish()
    {
         ...
         */
        if (self::$mySchema >= ARCHER_SCHEMA) {
            return new self;
        }
        /**
         * The sub get caller.
